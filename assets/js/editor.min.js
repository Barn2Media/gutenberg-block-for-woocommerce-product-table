...
(function (wp, ptbComponents, nonce) {
  ...
  wp.blocks.registerBlockType('barn2/wc-product-table', {
    ...
    edit: function edit(props) {
      ...
      var blockStructure = el(Fragment, null, [el(InspectorControls, null, [el(SettingsPanel, {
      ...
      }, [__('Lists products in a table view using the WooCommerce Product Table plugin.', 'wpt-block'), el('div', {
