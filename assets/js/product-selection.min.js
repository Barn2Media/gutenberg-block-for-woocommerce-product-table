...
(function (wp, nonce, data) {
  ...
  window.productTableBlockComponents.ProductSelection = withState({
    ...
    var modalOpened = _ref2.modalOpened,
        count = _ref2.count,
        isMatchall = _ref2.isMatchall,
    ...
    var filterSelectionModal = wp.element.createRef();
    ...
    var addFilter = function addFilter(filter) {
      ...
      var newFilters = JSON.parse(JSON.stringify(attributes.filters));
    ...
    return el('div', {
      ...
      onDelete: function onDelete(index) {
        ...
        for (var i in attributes.filters) {
          if (i !== index) {
    ...
    })), count != null ? "".concat(count, " products found") : 'Finding products...', el('span', {
    ...
    }, __('Select Products', 'wpt-block')), el('div', {
      className: 'customize-filters-modal',
      ref: filterSelectionModal
    }, [el('ul', {
      ...
      className: 'customize-filter-new-option attr-values',
      onChange: selectProductAttrValue
    }, getFilterSelectionOptionValues(data.attributes, true)), el('input', {
      className: 'customize-filter-new-option value',
      ...
      onClick: function onClick(e) {
        var newFilter = getNewFilter(filterSelectionModal.current, isMatchall);
        addFilter(newFilter);
      }
    }, __('Save', 'wpt-block'))])])]);
  });
