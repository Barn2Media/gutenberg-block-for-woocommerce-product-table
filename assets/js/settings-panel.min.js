...
(function (wp, nonce, data) {
  ...
  window.productTableBlockComponents.SettingsPanel = withState({
    ...
    return el('div', {
    ...
    }, __('Additional Settings', 'wpt-block')), el('div', {
      className: 'table-settings-panel-modal',
      ref: tableSettingsModalRef
    }, [el('h3', {}, __('Add to Cart Column', 'wpt-block')), el(SelectControl, {
      ...
      options: [{
        ...
        value: 'true',
        label: __('Show quantity selectors in the Add to Cart column', 'wpt-block')
      }, {
        value: 'false',
      ...
      options: [{
        ...
        value: 'dropdown',
        label: __('Dropdown lists in add to cart column', 'wpt-block')
      }, {
        value: 'separate',
        label: __('Separate rows in table (one per variation)', 'wpt-block')
      }],
      onChange: function onChange(value) {
        changeSetting('variations', value);
      }
    }), el('h3', {}, __('Table Controls', 'wpt-block')), el(SelectControl, {
      ...
      options: [{
        ...
        value: 'true',
        label: __('Show based on columns in the table', 'wpt-block')
      }, {
        value: 'custom',
